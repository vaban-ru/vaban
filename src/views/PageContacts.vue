<template>
  <base-page class="contacts">
    <base-container>
      ...
      <p class="contacts__paragraph">
        <span>Ссылки</span>
        <template :key="index" v-for="(link, index) in links">
          <a
            target="_blank"
            rel="noopener"
            class="contacts__link contacts__link--underline"
            :href="link.url"
            >{{ link.title }}</a
...
const links = [
  ...
  {
    title: "Telegram",
    url: "https://t.me/vaban_ru",
  },
  {
    title: "Вконтакте",
    url: "https://vk.com/vaban_ru",
  },
];

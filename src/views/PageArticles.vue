<template>
  <base-page class="articles">
    <base-container>
      <base-title>Статьи</base-title>
      <p
        v-for="article in articles"
        :key="`article-${article.id}`"
        class="articles__paragraph"
      >
        <span class="articles__link-date">
          {{ article.date }}
        </span>
        <a
...
const articles = [
  ...
  {
    id: 4,
    name: "Создание чертовски простого макета календаря с помощью CSS Grid, Moment.js и Vue.js",
  ...
  {
    id: 6,
    name: "5 Vuex плагинов которые вы можете использовать в своем следующем Vue.js проекте",
